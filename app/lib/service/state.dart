...
State _mapToState(Map<String, dynamic> map) {
  ...
  Rules rules = _mapToRules(map['rules']);
...
/// _mapToRules converts the Map to Rules.
Rules _mapToRules(Map<String, dynamic> m) {
  return new Rules(
...
/// _rulesToMap converts the Rules to a Map.
Map<String, dynamic> _rulesToMap(Rules r) {
  return {
